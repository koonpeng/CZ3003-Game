...
public class PrivateGirl extends Actor{
	...
	public void show()
	{
		...
		walkSheet = new Texture(Gdx.files.internal("privategirl.png"));
		...
		backgroundregion=new TextureRegion(new Texture(Gdx.files.internal("background.png")),0,0,628,478);
		backgroundimage=new Image(backgroundregion);
		backgroundimage.setPosition(0, 0);
		backgroundimage.setSize(628, 478);
