...
import cz3003.pptx.game.FightCharacter.STATE;
...
public class CreateQuestion extends Stage {
	...
	public void uiinit() {
		...
		selTF=new SelectBox<T>(style);
		
		
		/* ******Label Control Title Part****** */
		lblTitle = new Label("Question", style);
